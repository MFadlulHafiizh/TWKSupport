...
public class HorizontalDottedProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#D13C4F"));
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        for(int i = 0; i < mDotAmount; i++ ){
            if(i == mDotPosition){
                canvas.drawCircle(5+(i*20), mBounceDotRadius, mBounceDotRadius, paint);
            }else {
                canvas.drawCircle(5+(i*20), mBounceDotRadius, mDotRadius, paint);
            }
        }
